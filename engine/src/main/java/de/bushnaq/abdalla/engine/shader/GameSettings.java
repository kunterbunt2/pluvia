...
public class GameSettings {
	...
	public static final float	SHADOW_FAR				= 20;

	public static final float	SHADOW_INTENSITY		= 0.1f;
...
//	public static final int		SHADOW_MAP_WIDTH		= 4096;
	...
	public static final float	SHADOW_VIEWPORT_HEIGHT	= 1000;

	public static final float	SHADOW_VIEWPORT_WIDTH	= 1000;
