package com.abdalla.bushnaq.pluvia.model.turtle;
	...
	public void create(final GameEngine gameEngine) {
		if (instance == null) {
			if (gameEngine.renderEngine.isPbr()) {
				instance = new GameObject(new ModelInstanceHack(gameEngine.modelManager.turtleCubePbr[turtle.getType()].scene.model), null);
